...
ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'BindingTrade', 'Initial_Data', 'OrderJumpInfo.csv')
...
EXEC_ACT(ACT_BT_API.inputPaymentPageCreditInfo, '4311-9544-4444-4444', '22', '05', '222', '0900000000', 'jump')

# precondition-query order info and get allPayTradeNo

QUERY_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'BindingTrade', 'Initial_Data', 'QueryJumpInfo.csv')
...
BINDING_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'BindingTrade', 'BindingTrade_RAT_0026', 'BindingInfo.csv')
...
VERIFY(VER_BT_API.verifyColumns, binding_response_dict, 'BindingTrade_RAT_0026')
