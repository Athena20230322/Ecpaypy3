...
ecid_info = EXEC_ACT(ACT_API.genOrderRequestInfo, ECID_INFO_CSV, binding_response_dict, 'sleep(__TIME__)#')
...
VERIFY(VER_API.verifyReturnResult, 'Sorry! 很抱歉，目前網頁無回應，請重新整理或稍後再試！')
