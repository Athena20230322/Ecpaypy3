...
BINDING_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'BindingTrade', 'BindingTrade_RAT_0001',
                                'BindingInfo.csv')
...
VERIFY(VER_API.verifyClientRedirectColumnsCheck, client_dict, CASE_NAME)
