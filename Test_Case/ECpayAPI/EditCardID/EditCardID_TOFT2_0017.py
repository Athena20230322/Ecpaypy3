...
# server_text = EXEC_ACT(ACT_API.GetInfoFromServerReplyUrl, binding_info['MerchantTradeNo'])

client_text = EXEC_ACT(ACT_API.GetInfoFromPageWithoutClientURL)

# VERIFY

VERIFY(VER_API.verifyEmptyClientRedirectCheck, client_text)
