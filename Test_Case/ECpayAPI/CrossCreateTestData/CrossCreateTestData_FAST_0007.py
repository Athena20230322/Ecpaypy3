...
from ECpay.ProdActions.ActECpayAPI.ActCrossCreateTestData import actCrossCreateTestData
from ECpay.Verification.VerifyECpayAPI.VerifyCrossCreateTestData import verifyCrossCreateTestData
...
ACT_API = actCrossCreateTestData()
VER_API = verifyCrossCreateTestData()

#Testing exec

ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'CrossCreateTestData', CASE_NAME, 'OrderInfo.csv')
