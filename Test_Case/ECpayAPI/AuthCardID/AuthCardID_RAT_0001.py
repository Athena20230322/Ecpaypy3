...
BIND_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'BindingTrade', 'Initial_Data', 'OrderInfo.csv')

EXEC_ACT(BIND_API.enableWebOperate, DRIVER)

order_info = EXEC_ACT(BIND_API.genOrderRequestInfo, BIND_INFO_CSV)

EXEC_ACT(BIND_API.createOrderByBrowser, DRIVER, order_info, 'Chkout_API')

EXEC_ACT(BIND_API.inputPaymentPageCreditInfoE, '4311-9522-2222-2222', '23', '05', '222', '0900000000', ' autotest123@gmail.com','test', '')
