...
from ECpay.ProdActions.ActECpayAPI.ActInvIssueb2c1 import actInvIssueb2c1
from ECpay.Verification.VerifyECpayAPI.VerifyInvIssueb2c1 import verifyInvIssueb2c1
...
ACT_API = actInvIssueb2c1()
VER_API = verifyInvIssueb2c1()

#Testing exec

INV_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvIssueb2c', CASE_NAME, 'Inv.csv')
...
inv_info = EXEC_ACT(ACT_API.genOrderRequestInfoB2c, INV_INFO_CSV)
