...
ACT_API = actInvAllowanceb2c()
VER_API = verifyInvAllowanceb2c()

# Testing exec
# precondition-InvIssue
INV_ISSUE_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvAllowanceb2c', 'Initial_Data', 'InvIssue.csv')
...
# InvAllowance
INV_ALLOWANCE_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvAllowanceb2c', CASE_NAME, 'InvAllowance.csv')
...
api_response = EXEC_ACT(ACT_API.genPostRequestToAPIb2c, all_info)
