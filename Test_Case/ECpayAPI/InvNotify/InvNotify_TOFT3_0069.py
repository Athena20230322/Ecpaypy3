...
notify_info = EXEC_ACT(ACT_API.genOrderRequestInfo, NOTIFY_INFO_CSV, iss_res_dict, revert_args, "' or 1=1--")

notify_info_res = EXEC_ACT(ACT_API.genPostRequestToAPI, notify_info)

# InvNotify Verify

VERIFY(VER_API.verifyStatusResult, notify_info_res, 'MerchantID錯誤')
