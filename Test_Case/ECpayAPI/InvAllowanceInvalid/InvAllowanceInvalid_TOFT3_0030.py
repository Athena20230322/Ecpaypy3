...
INV_ISSUE_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvAllowanceInvalid', 'Initial_Data', 'InvIssue.csv')
...
INV_ALLOWANCE_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvAllowanceInvalid', 'Initial_Data', 'InvAllowance.csv')
...
# InvAllowanceInvalid
INV_ALLOWNACE_INVALID_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvAllowanceInvalid', CASE_NAME, 'Invalid.csv')
...
# verification
VERIFY(VER_API.verifyInjection, invalid_rtn_dict, all_rtn_dict, CASE_NAME)
