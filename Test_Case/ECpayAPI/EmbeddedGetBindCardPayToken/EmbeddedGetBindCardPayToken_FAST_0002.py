...
INV_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'EmbeddedGetBindCardPayToken', CASE_NAME, 'Tokenget.csv')

inv_info = EXEC_ACT(ACT_API1.genOrderRequestInfoGetTokenbyBindingCardv4, INV_INFO_CSV)
...
INV_INFO_CSV1 = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'EmbeddedGetBindCardPayToken', CASE_NAME, 'Keyexchange.csv')
...
QUERY_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'EmbeddedGetBindCardPayToken', CASE_NAME, 'Query.csv')

time.sleep(3)

query_info = EXEC_ACT(ACT_API.genOrderRequestInfoTokenQueryPlusv4, QUERY_INFO_CSV, data,data1)
