...
print('6563535')
inv_info = EXEC_ACT(ACT_API1.genOrderRequestInfoThreeDCoBrandingInfo, INV_INFO_CSV2)
...
query_info = EXEC_ACT(ACT_API5.genOrderRequestInfoTokenFlexible, QUERY_INFO_CSV, data8,data1)
