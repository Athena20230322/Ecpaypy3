...
#notify_info = EXEC_ACT(ACT_API.genOrderRequestInfoB2B01, NOTIFY_INFO_CSV, data1)
notify_info = EXEC_ACT(ACT_API.genOrderRequestInfoB2B6, NOTIFY_INFO_CSV, data1,"' or 1=1--")
...
#VERIFY(VER_API.verifyStatusResult, notify_info_res, '查無折讓單作廢資料，請確認!')

VERIFY(VER_API.verifyStatusResult, CASE_NAME,'')
