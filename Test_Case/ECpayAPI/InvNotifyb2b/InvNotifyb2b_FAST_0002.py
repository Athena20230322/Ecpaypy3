...
# from ECpay.ProdActions.ActECpayAPI.ActInvIssueInvalidb import actInvIssueInvalidb
...
data = EXEC_ACT(ACT_ISS_API.decryptDatab2b, iss_res_dict['Data'])
print(data)
...
notify_info = EXEC_ACT(ACT_API.genOrderRequestInfoB2B, NOTIFY_INFO_CSV,data)
...
res_dict = EXEC_ACT(ACT_API.strToDict, notify_info_res)
