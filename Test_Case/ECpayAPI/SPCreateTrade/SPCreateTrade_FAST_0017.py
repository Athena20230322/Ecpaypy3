...
EXEC_ACT(ACT_API.makeHtmlFileNew, html_path, data, 'ATM', 'ATM', '1')

EXEC_ACT(ACT_API.submitATMPaymentPanhsin)

res = EXEC_ACT(ACT_API.getResultfromBrowser, 'ATM')
...
VERIFY(VER_API.verifyRtnValuePanhsin, CASE_NAME, res_data)
