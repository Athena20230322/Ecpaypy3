...
ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'SPCreateTrade', 'Initial_Data', 'OrderInfo.csv')
...
EXEC_ACT(ACT_API.makeHtmlFileNew, html_path, data, 'CREDIT', 'CREDIT', '1')

EXEC_ACT(ACT_API.inputPaymentInfo, '4311-9522-2222-2222', '23', '05', '222', '0900000000', 'sam')
...
res = EXEC_ACT(ACT_API.getResultfromBrowser, 'CREDIT')
...
VERIFY(VER_API.verifyRtnValue, CASE_NAME, res_data)
# VER_API.verifyRtnValue(CASE_NAME, res_data)
