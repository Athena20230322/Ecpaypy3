...
print(order_info['MerchantTradeNo'])

EXEC_ACT(ACT_API.makeHtmlFileNew, html_path, data, 'CVS', 'CVS', '0')

EXEC_ACT(ACT_API.submitCVSPayment)

res = EXEC_ACT(ACT_API.getResultfromBrowser, 'CVS')
