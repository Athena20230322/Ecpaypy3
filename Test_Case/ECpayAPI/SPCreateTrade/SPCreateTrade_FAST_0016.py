...
ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'SPCreateTrade', 'SPCreateTrade_FAST_0061', 'OrderInfo.csv')
...
EXEC_ACT(ACT_API.inputPaymentInfoE, '4311-9522-2222-2222', '23', '05', '222', '0900000000','autoecpay123@gmail.com','test')
