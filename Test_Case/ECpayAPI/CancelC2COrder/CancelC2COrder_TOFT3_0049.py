...
order_info_cancel_c2c = EXEC_ACT(ACT_API.genOrderRequestC2C, ORDER_INFO_C2C, modify_str, "1 or sleep(__TIME__)#")

EXEC_ACT(ACT_API.createOrderByBrowser, DRIVER, order_info_cancel_c2c, 'Cancel_C2C_API')

VERIFY(VER_API.verifyStatusResult, '0|AllPayLogisticsID必須為整數。')
