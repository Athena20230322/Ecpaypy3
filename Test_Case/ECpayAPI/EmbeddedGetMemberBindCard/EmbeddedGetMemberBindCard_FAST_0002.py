...
ACT_API = actEmbeddedgetuiinfo()
VER_API = verifyEmbeddedgetuiinfo()
...
INV_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'EmbeddedGetMemberBindCard', CASE_NAME, 'Tokenget.csv')

inv_info = EXEC_ACT(ACT_API1.genOrderRequestInfoGetTokenBindingCard, INV_INFO_CSV)
...
INV_INFO_CSV1 = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'EmbeddedGetMemberBindCard', CASE_NAME, 'Keyexchange.csv')
...
QUERY_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'EmbeddedGetMemberBindCard', CASE_NAME, 'Query.csv')
