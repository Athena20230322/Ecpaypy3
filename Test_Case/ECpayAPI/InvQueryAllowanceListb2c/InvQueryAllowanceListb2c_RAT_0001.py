...
from ECpay.ProdActions.ActECpayAPI.ActInvQueryAllowanceListb2c import actInvQueryAllowanceListb2c
from ECpay.Verification.VerifyECpayAPI.VerifyInvQueryAllowanceListb2c import verifyInvQueryAllowanceListb2c
...
ACT_API = actInvQueryAllowanceListb2c()
VER_API = verifyInvQueryAllowanceListb2c()

# Testing exec

# precondition-InvIssue

INV_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvQueryAllowanceListb2c', 'Initial_Data', 'Inv.csv')
...
INV_ALLOWANCE_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvQueryAllowanceListb2c', 'Initial_Data', 'InvAllowance.csv')

#invoice_info_dict = EXEC_ACT(ACT_ALLOWANCE_API.strToDict, invoice_rtn)
...
Query_ALLOWANCE_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvQueryAllowanceListb2c', CASE_NAME, 'OrderInfo.csv')

inv_query_info = EXEC_ACT(ACT_API.genOrderRequestInfoListB2c, Query_ALLOWANCE_INFO_CSV, data)

# print 'genOrderRequestInfo: ', inv_query_info

order_info_res = EXEC_ACT(ACT_API.genPostRequestToAPIListb2c, inv_query_info)
...
#VERIFY(VER_API.verifyInvQueryAllowanceResult, CASE_NAME,data)
