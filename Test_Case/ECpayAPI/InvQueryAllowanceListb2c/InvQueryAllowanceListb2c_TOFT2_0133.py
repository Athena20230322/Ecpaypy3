...
INV_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvIssueb2c', 'InvIssueb2c_TOFT2_0133', 'Inv.csv')
...
INV_ALLOWANCE_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvAllowanceb2c', 'InvAllowanceb2c_TOFT2_0133', 'InvAllowance.csv')
