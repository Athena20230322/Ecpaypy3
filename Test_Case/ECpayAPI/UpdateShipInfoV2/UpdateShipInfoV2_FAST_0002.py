...
from ECpay.ProdActions.ActECpayAPI.ActUpdateShipInfoV2 import actUpdateShipInfoV2
from ECpay.Verification.VerifyECpayAPI.VerifyUpdateShipInfoV2 import verifyUpdateShipInfoV2
...
ACT_API = actUpdateShipInfoV2()
VER_API = verifyUpdateShipInfoV2()
...
time.sleep(5)
response = EXEC_ACT(ACT_API1.submitLogisticsRequestUNI)
...
data = EXEC_ACT(ACT_API2.decryptDatab2c132, order_info_res_dict['Data'])
print(data)




QUERY_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'QueryLogisticsTradeInfoV2', 'QueryLogisticsTradeInfoV2_TOFT2_0006', 'OrderInfo1.csv')

query_info = EXEC_ACT(ACT_API3.genOrderRequestInfoB2cQueryb2c, QUERY_INFO_CSV,data)
...
data1 = EXEC_ACT(ACT_API3.decryptDatab2c132, order_info_res_dict['Data'])
print(data1)
...
ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'UpdateShipInfoV2', CASE_NAME, 'UpdateShipInfoV2.csv')

order_info = EXEC_ACT(ACT_API.genOrderRequestInfoB2cShipInfoV2, ORDER_INFO_CSV,data1)
...
data2 = EXEC_ACT(ACT_API.decryptDatab2cUpdateShipInfo, order_info_res_dict['Data'])
print(data2)
