...
BINDING_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'DeleteCardID', 'Initial_Data', 'BindingInfo.csv')
...
VERIFY(VER_API.verifyColumns, delete_res_dict, CASE_NAME)
