...
from ECpay.ProdActions.ActECpayAPI.ActEmbeddedtokenGv4 import actEmbeddedtokenGv4
from ECpay.Verification.VerifyECpayAPI.VerifyEmbeddedtokenGv4 import verifyEmbeddedtokenGv4
...
ACT_API = actEmbeddedtokenGv4()
VER_API = verifyEmbeddedtokenGv4()

#Testing exec

INV_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'EmbeddedTokenGv4', CASE_NAME, 'Inv.csv')
...
EXEC_ACT(ACT_API.Login,'gatewaytest01','53538851','test1234')
