...
ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'CreditCardPeriodAction', CASE_NAME, 'OrderInfo1.csv')
...
order_info = EXEC_ACT(ACT_API.genOrderRequestInfo1, QUERY_TRADE_INFO_CSV,MERC_TID)
...
# ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'CreditCardPeriodAction', CASE_NAME, 'OrderInfo2.csv')
#
# order_info = EXEC_ACT(ACT_API.genOrderRequestInfo, ORDER_INFO_CSV)
#
# #res = EXEC_ACT(ACT_API.createOrderByRequestThreeD, order_info)
#
# order_info_res = EXEC_ACT(ACT_API.genPostRequestToAPIN, order_info)
#
# res_dict = EXEC_ACT(ACT_API.strToDict, order_info_res)
#
...
# print data
#
# VERIFY(VER_API.verifyResponseValues, CASE_NAME, res_dict, data)
