...
order_info_home = EXEC_ACT(ACT_API.genOrderRequestHome, ORDER_INFO_CSV_C2C, "' or 1=1--")

order_info_rehome_res = EXEC_ACT(ACT_API.genPostStatusCode, order_info_home, 'ReHome_API')

VERIFY(VER_API.verifyStatusResult, order_info_rehome_res, '500')
