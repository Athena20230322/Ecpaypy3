...
ORDER_INFO_CSV_CRT = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'ReturnHome', 'Initial_Data', 'Create_FAST_0002.csv')
...
order_info_home = EXEC_ACT(ACT_API.genOrderRequestHome, ORDER_INFO_CVS_C2C, modify_str)
