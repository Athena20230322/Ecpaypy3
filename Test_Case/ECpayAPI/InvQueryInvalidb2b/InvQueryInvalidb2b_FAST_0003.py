...
data3 = EXEC_ACT(INVALID_API.decryptDatab2b2, invalid_info['Data'])
data2 = EXEC_ACT(ISSUE_API.decryptDatab2b2, res_dict1['Data'])
data1 = EXEC_ACT(ISSUE_API.decryptDatab2b2,issue_info['Data'])
data = EXEC_ACT(ACT_API.decryptDatab2b2, res_dict['Data'])
# verification
VERIFY(VER_API.verifyResponseValueb2b, data,data1,data2,data3,CASE_NAME)
