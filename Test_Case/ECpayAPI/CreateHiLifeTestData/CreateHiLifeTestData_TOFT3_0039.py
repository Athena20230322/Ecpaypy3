...
ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'CreateHiLifeTestData', CASE_NAME, 'OrderInfo.csv')

order_info = EXEC_ACT(ACT_API.genOrderRequestInfo, ORDER_INFO_CSV, "' 1=1 /*")

order_info_res = EXEC_ACT(ACT_API.genPostRequestToAPI, order_info)

VERIFY(VER_API.verifyStatusResult, order_info_res, '500')
