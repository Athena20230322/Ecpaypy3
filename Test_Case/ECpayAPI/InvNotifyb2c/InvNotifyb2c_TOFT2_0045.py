...
data = EXEC_ACT(ACT_ALL_API.decryptDatab2c,  all_res_dict['Data'])
print(data)
...
alliv_info = EXEC_ACT(ACT_ALLIV_API.genOrderRequestInfoB2c, ALLIV_INFO_CSV, data)
...
data = EXEC_ACT(ACT_ALL_API.decryptDatab2c,  alliv_res_dict['Data'])
print(data)

# precondition-AllowanceInvalid Verify

VERIFY(VER_ALLIV_API.verifyColumn, 'InvAllowanceInvalidb2c_RAT_0001',data)
...
notify_info = EXEC_ACT(ACT_API.genOrderRequestInfoB2c2, NOTIFY_INFO_CSV, data)
