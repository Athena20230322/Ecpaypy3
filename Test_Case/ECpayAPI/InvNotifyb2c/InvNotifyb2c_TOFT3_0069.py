...
notify_info = EXEC_ACT(ACT_API.genOrderRequestInfoB2c5, NOTIFY_INFO_CSV, data, "' or 1=1--")
...
#VERIFY(VER_API.verifyStatusResult, notify_info_res, 'MerchantID Parameters Error')
