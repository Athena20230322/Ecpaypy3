...
from ECpay.ProdActions.ActECpayAPI.ActUpdateStoreInfo import actUpdateStoreInfo
from ECpay.Verification.VerifyECpayAPI.VerifyUpdateStoreInfo import verifyUpdateStoreInfo
...
ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'UpdateStoreInfo', 'Initial_Data', 'OrderInfo.csv')
...
C2C_ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_data', 'ECpayAPI', 'UpdateStoreInfo', 'Initial_Data', 'Create.csv')
...
#UpdateStoreInfo api
UPDATE_STORE_INFO_CSV = os.path.join(ROOTDIR, 'Test_data', 'ECpayAPI', 'UpdateStoreInfo', CASE_NAME, 'OrderInfo.csv')

update_store_info = EXEC_ACT(ACT_API.genUpdateStoreInfo, UPDATE_STORE_INFO_CSV, '" or sleep(__TIME__)="',
