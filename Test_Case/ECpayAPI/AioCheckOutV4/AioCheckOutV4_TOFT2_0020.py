...
EXEC_ACT(ACT_API.inputPaymentPageCreditInfoLanguageUE, '4311-9544-4444-4444', '222', '0900000000' , 'autotest123@gmail.com', 'test')

# EXEC_ACT(ACT_API.inputOTP)

# otp_info = EXEC_ACT(ACT_API.queryCreditOTPLanguage, '0900000000', 'ECpay_Credit_Payment_JPN')
#
...
VERIFY(VER_API.verifyLanguage, 'JPN')
