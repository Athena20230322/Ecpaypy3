...
from ECpay.ProdActions.ActECpayAPI.ActReturnHiLifeCVSV2 import actReturnHiLifeCVSV2
from ECpay.Verification.VerifyECpayAPI.VerifyReturnHiLifeCVSV2 import verifyReturnHiLifeCVSV2
...
ACT_API2 = actReturnHiLifeCVSV2()
VER_API2 = verifyReturnHiLifeCVSV2()
...
#Testing exec
ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'ReturnHiLifeCVSV2', CASE_NAME, 'OrderInfo.csv')
