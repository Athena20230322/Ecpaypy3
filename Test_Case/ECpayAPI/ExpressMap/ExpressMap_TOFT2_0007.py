...
ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'ExpressMap', 'Initial_Data', 'C2COrder.csv')

EXEC_ACT(ACT_API.enableWebOperate, DRIVER)

EXEC_ACT(ACT_API.changeC2CHash)

order_info = EXEC_ACT(ACT_API.genOrderInfo, ORDER_INFO_CSV)

EXEC_ACT(ACT_API.createOrderByBrowser, DRIVER, order_info)

#EXEC_ACT(ACT_API.inputC2CPaymentPageCreditInfo, u'王大明', '4311-9522-2222-2222', '22', '05', '222')
...
EXEC_ACT(ACT_API.ChooseUniMartStore, DRIVER)
...
#VERIFY
VERIFY(VER_API.verifyUniMartReturnResult, response, map_req_info)
