...
ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'CreditCardPeriodActionB', CASE_NAME, 'OrderInfo1.csv')
...
order_info = EXEC_ACT(ACT_API1.genOrderRequestInfo, ORDER_INFO_CSV,MERC_TID)
...
data = EXEC_ACT(ACT_API1.decryptData3D, res_dict['Data'])
print(data)
