...
from ECpay.ProdActions.ActECpayAPI.ActInvTrigger import actInvTrigger
from ECpay.Verification.VerifyECpayAPI.VerifyInvTrigger import verifyInvTrigger
...
DELAY_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvTrigger', 'Initial_Data', 'InvDelay.csv')
...
TRIGGER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvTrigger', CASE_NAME, 'InvTrigger.csv')
...
# verification
VERIFY(VER_API.verifyInjection, trigger_rtn_dict, delay_rtn_dict, CASE_NAME)
