...
from ECpay.ProdActions.ActECpayAPI.ActEmbeddedCreatePayment import actEmbeddedcreatepayment
from ECpay.Verification.VerifyECpayAPI.VerifyEmbeddedCreatePayment import verifyEmbeddedcreatepayment
...
ACT_API = actEmbeddedcreatepayment()
VER_API = verifyEmbeddedcreatepayment()
...
INV_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'EmbeddedCreatePayment', CASE_NAME, 'Tokenget.csv')

inv_info = EXEC_ACT(ACT_API1.genOrderRequestInfoThreeD2, INV_INFO_CSV)
...
INV_INFO_CSV1 = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'EmbeddedCreatePayment', CASE_NAME, 'Keyexchange.csv')
...
QUERY_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'EmbeddedCreatePayment', CASE_NAME, 'GetPaytoken.csv')
...
QUERY_INFO_CSV1 = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'EmbeddedCreatePayment', CASE_NAME, 'GetCreatepayment.csv')
