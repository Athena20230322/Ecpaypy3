...
ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'Create', 'Initial_Data', 'AioCheckOutLimitAmount.csv')
...
result = order_info_crt_res.decode('utf-8')
...
#Verify
VERIFY(VER_API.verifyResult, result)
