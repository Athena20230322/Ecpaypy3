...
INV_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvQueryAllowanceb2c', 'Initial_Data', 'Inv.csv')
...
INV_ALLOWANCE_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvQueryAllowanceb2c', 'Initial_Data', 'InvAllowance.csv')
...
inv_query_info = EXEC_ACT(ACT_API.genOrderRequestInfoB2c, Query_ALLOWANCE_INFO_CSV, data, "hi' or 1=1--")
print(inv_query_info)
...
VERIFY(VER_API.verifyInvQueryAllowanceResultb2cforerr,data,CASE_NAME)
