...
data = EXEC_ACT(ALL_API.decryptDatab2c, rtn_dict['Data'])
print(data)
...
inv_query_info = EXEC_ACT(ACT_API.genOrderRequestInfoB2c, Query_ALLINVALID_INFO_CSV,data,data1, "hi' or 1=1--")
