...
from ECpay.ProdActions.ActECpayAPI.ActInvOfflineInvalid import actInvOfflineInvalid
from ECpay.Verification.VerifyECpayAPI.VerifyInvOfflineInvalid import verifyInvOfflineInvalid
...
ACT_API2 = actInvOfflineInvalid()
VER_API2 = verifyInvOfflineInvalid()
...
INV_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvOfflineIssue', 'InvOfflineIssue_RAT_0003', 'Inv1.csv')
...
# InvQuery
QUERY_INFO_CSV1 = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvOfflineInvalid', CASE_NAME, 'Query.csv')

query_info = EXEC_ACT(ACT_API2.genOrderRequestInfoInvOfflineInvalid, QUERY_INFO_CSV1,data1)

query_rtn = EXEC_ACT(ACT_API2.genPostRequestToAPIWordSetting, query_info)

query_rtn_dict = EXEC_ACT(ACT_API2.strToDict, query_rtn)

data2 = EXEC_ACT(ACT_API2.decryptDatab2c2, query_rtn_dict['Data'])
print(data2)

# verification
VERIFY(VER_API2.verifyResponseValueb2c, CASE_NAME, data2)
time.sleep(3)
