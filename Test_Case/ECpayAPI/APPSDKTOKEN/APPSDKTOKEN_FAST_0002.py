...
from ECpay.ProdActions.ActECpayAPI.ActAppsdktoken import actAppsdktoken
from ECpay.Verification.VerifyECpayAPI.VerifyAppsdktoken import verifyAppsdktoken
...
ACT_API = actAppsdktoken()
VER_API = verifyAppsdktoken()

#Testing exec

INV_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'APPSDKTOKEN', CASE_NAME, 'Inv.csv')
