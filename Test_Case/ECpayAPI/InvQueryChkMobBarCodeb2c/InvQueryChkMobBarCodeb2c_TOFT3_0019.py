...
query_mobarcode_info = EXEC_ACT(ACT_API.genOrderRequestInfoB2c, QUERY_MOBARCODE_INFO_CSV, "' or 1=1--")
...
VERIFY(VER_API.verifyStatusResult, query_mobarcode_info_res, 'Data decrypt fail')

#VERIFY(VER_API.verifyInvQueryChkMobBarCodeRequestInfob2c,CASE_NAME,data)
