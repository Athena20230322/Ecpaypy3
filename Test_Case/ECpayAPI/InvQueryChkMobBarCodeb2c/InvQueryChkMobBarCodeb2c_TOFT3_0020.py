...
query_mobarcode_info = EXEC_ACT(ACT_API.genOrderRequestInfoB2c, QUERY_MOBARCODE_INFO_CSV,"&*'1=1/*")
...
VERIFY(VER_API.verifyStatusResult, data, '[Barcode] 手機條碼 為8碼，以/開頭的0-9A-Z+-.所組成之字串')
