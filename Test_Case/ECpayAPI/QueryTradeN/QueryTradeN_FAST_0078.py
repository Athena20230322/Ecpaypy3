...
from ECpay.ProdActions.ActECpayAPI.ActQueryTradeN import actQueryTradeN
from ECpay.Verification.VerifyECpayAPI.VerifyQueryTradeN import verifyQueryTradeN
...
ACT_API = actQueryTradeN()
VER_API = verifyQueryTradeN()

#Testing exec

ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'QueryTradeN', CASE_NAME, 'OrderInfo.csv')
