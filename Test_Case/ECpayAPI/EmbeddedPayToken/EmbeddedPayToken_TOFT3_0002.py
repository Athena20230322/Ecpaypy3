...
INV_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'EmbeddedPayToken', CASE_NAME, 'Tokenget1.csv')

inv_info = EXEC_ACT(ACT_API3.genOrderRequestInfoThreeD2, INV_INFO_CSV)
