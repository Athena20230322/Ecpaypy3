...
order_info_returncvs = EXEC_ACT(ACT_API.genOrderRequestCVS, ORDER_INFO_C2C, modify_str, False, False, "' or 1=1--")

EXEC_ACT(ACT_API.createOrderByBrowser, DRIVER, order_info_returncvs, 'ReturnCVS_API')

#由於編碼格式不同需使用u進行轉碼，否則會導致錯誤
VERIFY(VER_API.verifyStatusResult, '|很抱歉，此帳號目前暫停使用，如有問題請洽客服協助。')
