...
from ECpay.ProdActions.ActECpayAPI.ActCancelC2COrderV2 import actCancelC2COrderV2
from ECpay.Verification.VerifyECpayAPI.VerifyCancelC2COrderV2 import verifyCancelC2COrderV2
...
ACT_API = actCancelC2COrderV2()
VER_API = verifyCancelC2COrderV2()
...
QUERY_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'QueryLogisticsTradeInfoV2', 'QueryLogisticsTradeInfoV2_TOFT2_0006', 'OrderInfo.csv')
...
ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'CancelC2COrderV2', CASE_NAME, 'OrderInfoCancel.csv')

order_info = EXEC_ACT(ACT_API.genOrderRequestInfoB2cCancel, ORDER_INFO_CSV,data1)
