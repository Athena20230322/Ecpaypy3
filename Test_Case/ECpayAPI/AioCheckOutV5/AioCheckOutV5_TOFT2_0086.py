...
EXEC_ACT(ACT_API.inputPaymentPageCreditInfoBind, '4311-9544-4444-4444', '23', '05', '222', '0900000000', 'divide','test', True)

# 因為有PlatformID所以不用OTP
# otp_info = EXEC_ACT(ACT_API.queryCreditOTP, '0900000000')
#
# EXEC_ACT(ACT_API.inputOTP, otp_info)

# 新規格有PlatformID時應走自身MID設定，因此需OTP
