...
inv_query_info = EXEC_ACT(ACT_API.genOrderRequestInfoB2B, Query_ALLOWANCE_INFO_CSV, data, "hi' or 1=1--")
...
VERIFY(VER_API.verifyInvQueryAllowanceResultb2bforerr,data,CASE_NAME)
