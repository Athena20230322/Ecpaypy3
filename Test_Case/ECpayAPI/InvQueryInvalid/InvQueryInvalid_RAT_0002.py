...
from ECpay.ProdActions.ActECpayAPI.ActInvQueryInvalid import actInvQueryInvalid
from ECpay.Verification.VerifyECpayAPI.VerifyInvQueryInvalid import verifyInvQueryInvalid
...
ISSUE_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvQueryInvalid', 'Initial_Data', 'InvIssue.csv')
...
INVALID_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvQueryInvalid', 'Initial_Data', 'InvIssueInvalid.csv')
...
# InvQueryInvalid
QUERY_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvQueryInvalid', CASE_NAME, 'InvQueryInvalid.csv')

query_info = EXEC_ACT(ACT_API.genOrderRequestInfo, QUERY_INFO_CSV, issue_info)

query_info = EXEC_ACT(ACT_API.clearChkMacValue, query_info)
