...
rtn_dict = EXEC_ACT(ALL_API.strToDict, all_rtn)

data = EXEC_ACT(ALL_API.decryptDatab2b, rtn_dict['Data'])
print(data)
...
rtn_dict = EXEC_ACT(ALL_API.strToDict, invalid_rtn)
...
inv_query_info = EXEC_ACT(ACT_API.genOrderRequestInfoB2B, Query_ALLINVALID_INFO_CSV,data,data1, "hi' or 1=1--")

# print 'genOrderRequestInfo: ', inv_query_info

order_info_res = EXEC_ACT(ACT_API.genPostRequestToAPI, inv_query_info)

VERIFY(VER_API.verifyStatusResult, order_info_res, '')
