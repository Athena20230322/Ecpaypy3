...
ORDER_INFO_CSV_CRT = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'printTradeDocument',
                                  'Initial_Data', 'Create_UNIMART.csv')
...
#VERIFY(VER_API.verifyprintTradeDocUNIMART, order_info_crt['ReceiverName'], order_info_crt['ReceiverStoreID'],
