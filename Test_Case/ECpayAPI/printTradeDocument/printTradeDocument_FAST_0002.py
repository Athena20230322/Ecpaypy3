...
# EXEC_ACT(PTD_APT.inputPaymentPageCreditInfoEC, '4311-9522-2222-2222', '22', '05', '222', '0900000000')
...
# VERIFY(VER_API.verifyprintTradeDocFAMI, order_info_crt['ReceiverName'], order_info_crt['ReceiverStoreID'],
#        modify_str, order_info_crt['MerchantTradeNo'])
