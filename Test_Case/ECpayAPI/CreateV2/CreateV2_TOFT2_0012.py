...
time.sleep(5)
response = EXEC_ACT(ACT_API.submitLogisticsRequestPOSTOFFICE)


res_in_CliReUrl = EXEC_ACT(ACT_API.GetInfoFromClientRedirectUrl)

res_in_CliReUrl_dict = EXEC_ACT(ACT_API.strToDict, res_in_CliReUrl)
...
#VERIFY(VER_API.verifyResponseValuesb2c, CASE_NAME,response)
