...
ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'BindingTrade', 'Initial_Data', 'OrderSuntoryInfo.csv')
...
EXEC_ACT(ACT_API.inputPaymentPageCreditInfoSP, '4311-9522-2222-2222', '23', '05', '222', '0900000000','test', '')
print('order_info: ', order_info)
# precondition-query order info and get AllpayTradeNo
EXEC_ACT(ACT_API.inputOTPCredit, '1234')
QUERY_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'BindingTrade', 'Initial_Data', 'QuerySuntoryInfo.csv')
