...
from  ECpay.ProdActions.ActECpayAPI.ActAioCheckOut214 import actAioCheckOut214
from ECpay.Verification.VerifyECpayAPI.VerifyAioCheckOut214 import verifyAioCheckOut214
...
ACT_API = actAioCheckOut214()
VER_API = verifyAioCheckOut214()
...
EXEC_ACT(ACT_API.inputPaymentPageCreditInfo, '4311-9544-4444-4444', '22', '05', '222', '0963957452','autoecpay123@gmail.com', 'divide')
