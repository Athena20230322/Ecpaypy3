...
from ECpay.ProdActions.ActECpayAPI.ActReturnUniMartCVSV2 import actReturnUniMartCVSV2
from ECpay.Verification.VerifyECpayAPI.VerifyReturnUniMartCVSV2 import verifyReturnUniMartCVSV2
...
ACT_API = actReturnUniMartCVSV2()
VER_API = verifyReturnUniMartCVSV2()

#Testing exec

ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'ReturnUniMartCVSV2', CASE_NAME, 'OrderInfo.csv')
