...
ACT_API = actCreateByTempTradeV2()
VER_API = verifyCreateByTempTradeV2()
...
order_info = EXEC_ACT(ACT_API.genOrderRequestInfoB2cCreateBy, ORDER_INFO_CVS_CRT,res_in_CliReUrl_dict)
