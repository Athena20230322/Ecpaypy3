...
from ECpay.ProdActions.ActECpayAPI.ActInvCancelDelayIssueb2c import actInvCancelDelayIssueb2c
from ECpay.Verification.VerifyECpayAPI.VerifyInvCancelDelayIssueb2c import verifyInvCancelDelayIssueb2c
...
ACT_API = actInvCancelDelayIssueb2c()
VER_API = verifyInvCancelDelayIssueb2c()

# Testing exec
# precondition-InvDelay
DELAY_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvCancelDelayIssueb2c', 'Initial_Data', 'InvDelay.csv')
...
TRIGGER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvCancelDelayIssueb2c', CASE_NAME, 'InvCancelDelayIssue.csv')
...
# res_dict = EXEC_ACT(ACT_API.strToDict, trigger_rtn_dict)

data1 = EXEC_ACT(ACT_API.decryptDatab2c2, trigger_rtn_dict['Data'])
print(data1)

# verification
VERIFY(VER_API.verifyResponseValue,data1,data,CASE_NAME)
