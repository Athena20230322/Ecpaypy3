...
EXEC_ACT(ACT_API.inputPaymentPageCreditInfo, '4311-9533-3333-3333', '22', '05', '222', '0900000000')
...
time.sleep(5)
#VERIFY(VER_API.verifyInvQuery, MERC_TID, {'PayAmt':'100'})

VERIFY(VER_API.verifyInvQuery, MERC_TID, CASE_NAME)

#VER_API.verifyInvQuery(MERC_TID, CASE_NAME)
