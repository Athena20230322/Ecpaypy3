...
INV_ISSUE_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvQuery', 'Initial_Data', 'InvIssue.csv')
...
INV_ALLOWANCE_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvAllowance', 'InvAllowance_RAT_0001', 'InvAllowance.csv')
