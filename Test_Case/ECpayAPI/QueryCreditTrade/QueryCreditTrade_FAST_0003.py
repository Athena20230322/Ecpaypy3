...
#
# EXEC_ACT(ACT_API.inputPaymentPageCreditInfo, '4311-9522-2222-2222', '22', '05', '222', '0900000000','test')
#
...
order_info = EXEC_ACT(ACT_API.genQueryRequestInfo, ORDER_INFO_CSV, 'fa4d0044bb98438188e')

response_json = EXEC_ACT(ACT_API.queryCreditCardPeriodInfo, order_info)

# VERIFY
VERIFY(VER_API.verifyQueryInfo1, response_json, CASE_NAME)
