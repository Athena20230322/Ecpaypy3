...
from ECpay.ProdActions.ActECpayAPI.ActPrintHILIFEC2COrder import actPrintHILIFEC2COrder
from ECpay.Verification.VerifyECpayAPI.VerifyPrintHILIFEC2COrder import verifyPrintHILIFEC2COrder
...
ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'PrintHILIFEC2COrder', 'Initial_Data', 'OrderInfo.csv')
...
C2C_ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_data', 'ECpayAPI', 'PrintHILIFEC2COrder', 'Initial_Data', 'Create.csv')
...
PRINT_HILIFE_C2C_CSV = os.path.join(ROOTDIR, 'Test_data', 'ECpayAPI', 'PrintHILIFEC2COrder', CASE_NAME, 'OrderInfo.csv')
...
ele = EXEC_ACT(ACT_API.getPrintElementExist)
