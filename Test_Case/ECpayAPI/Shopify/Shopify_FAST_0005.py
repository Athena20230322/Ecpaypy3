...
EXEC_ACT(ACT_API.inputPaymentPageCreditInfoShopify, '4311-9544-4444-4444', '22', '05', '222', '0900000000', 'divide','test', ' autotest123@gmail.com')
time.sleep(5)
...
query_rtn = EXEC_ACT(ACT_API.genPostRequestToAPINohtmlrefund,shopify_info)
