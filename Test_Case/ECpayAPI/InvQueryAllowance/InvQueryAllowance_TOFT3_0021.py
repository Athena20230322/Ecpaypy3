...
from ECpay.ProdActions.ActECpayAPI.ActInvQueryAllowance import actInvQueryAllowance
from ECpay.Verification.VerifyECpayAPI.VerifyInvQueryAllowance import verifyInvQueryAllowance
...
INV_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvQueryAllowance', 'Initial_Data', 'Inv.csv')
...
INV_ALLOWANCE_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvQueryAllowance', 'Initial_Data', 'InvAllowance.csv')
...
Query_ALLOWANCE_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvQueryAllowance', CASE_NAME, 'OrderInfo.csv')

inv_query_info = EXEC_ACT(ACT_API.genOrderRequestInfo, Query_ALLOWANCE_INFO_CSV, res_dict, "' or 1=1--")

# print 'genOrderRequestInfo: ', inv_query_info

order_info_res = EXEC_ACT(ACT_API.genPostRequestToAPI, inv_query_info)

VERIFY(VER_API.verifyStatusResult, order_info_res, 'MerchantID錯誤')
