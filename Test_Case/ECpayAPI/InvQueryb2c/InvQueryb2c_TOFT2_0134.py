...
INV_ISSUE_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'ECpayAPI', 'InvIssueb2c', 'InvIssueb2c_TOFT2_0134', 'Inv.csv')
...
data2 = EXEC_ACT(ACT_API.decryptDatab2c2, query_rtn_dict['Data'])
data = EXEC_ACT(ISSUE_API.decryptDatab2c2, res_dict['Data'])
data1=EXEC_ACT(ISSUE_API.decryptDatab2c2, inv_info['Data'])
# verification
VERIFY(VER_API.verifyResponseValueTax, data2, data1, data, CASE_NAME)
