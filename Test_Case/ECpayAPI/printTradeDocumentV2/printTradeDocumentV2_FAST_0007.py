...
response = EXEC_ACT(ACT_API1.submitLogisticsRequestHAI)
...
data = EXEC_ACT(ACT_API.decryptDatac2c, order_info_res_dict['Data'])
print(data)
...
query_info = EXEC_ACT(ACT_API.genOrderRequestInfoC2cLog, QUERY_INFO_CSV,data)
...
#EXEC_ACT(ACT_API.printC2C, DRIVER)

#print_info_dict = EXEC_ACT(ACT_API.getPrintElementsHAI, DRIVER)
