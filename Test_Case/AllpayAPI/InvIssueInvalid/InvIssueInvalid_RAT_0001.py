...
INV_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'AllpayAPI', 'InvIssue', 'InvIssue_RAT_0001', 'Inv.csv')
...
ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'AllpayAPI', 'InvIssueInvalid', CASE_NAME, 'OrderInfo.csv')
...
#VERIFY(VER_API.verifyIssueInvalidResult, res_issue_invalid_dict, 'RAT')
