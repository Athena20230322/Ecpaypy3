...
EXEC_ACT(ACT_API.inputPaymentPageCreditInfo, 'F128029956', '4311-9522-2222-2222', '16', '05', '222', '0911429215')
...
#VERIFY
VERIFY(VER_API.verifyFailQueryInfo, response_json, CASE_NAME)
