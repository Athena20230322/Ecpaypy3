...
EXEC_ACT(ACT_API.clickLogIn, DRIVER)

EXEC_ACT(ACT_API.inputPaymentPageCreditInfo, 'F128029956', '4311-9522-2222-2222', '22', '05', '222', '0911429215', 'orderFirst')

EXEC_ACT(ACT_API.login, DRIVER,  'test0001', 'pw0001')

EXEC_ACT(ACT_API.openCaptchaInNewTab, DRIVER)

captcha = EXEC_ACT(ACT_API.resolveCaptchaFromNewTab, ROOTDIR, DRIVER)

EXEC_ACT(ACT_API.inputCaptchaAndSubmit, DRIVER, captcha)
...
#VERIFY
VERIFY(VER_API.verifyQueryInfo, response_json, CASE_NAME)
