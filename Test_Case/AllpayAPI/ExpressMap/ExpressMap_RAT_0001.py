...
from Allpay.ProdActions.ActAllpayAPI.ActExpressMap import actExpressMap
from Allpay.Verification.VerifyAllpayAPI.VerifyExpressMap import verifyExpressMap
...
#ExpressMap
MAP_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'AllpayAPI', 'ExpressMap', CASE_NAME, 'OrderInfo.csv')
