...
EXEC_ACT(BIND_API.inputRedirectPaymentPageCreditInfo, '4311-9544-4444-4444', '22', '05', '222')
...
BINDING_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'AllpayAPI', 'BindingTradeRedirect', 'BindingTradeRedirect_RAT_0001', 'BindingInfo.csv')
