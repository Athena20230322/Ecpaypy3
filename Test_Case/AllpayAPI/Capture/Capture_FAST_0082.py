...
CREATE_ORDER_CSV = os.path.join(ROOTDIR, 'Test_Data', 'AllpayAPI', 'Capture', 'Initial_Data', 'CreateOrderInfo.csv')
...
EXEC_ACT(ACT_API.chooseBank, DRIVER, '0922652130')

EXEC_ACT(ACT_API.login, DRIVER, 'andrew0001', 'pw0001')
