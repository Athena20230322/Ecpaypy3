...
from Allpay.ProdActions.ActAllpayAPI.ActInvQueryAllowanceInvalid import actInvQueryAllowanceInvalid
from Allpay.Verification.VerifyAllpayAPI.VerifyInvQueryAllowanceInvalid import verifyInvQueryAllowanceInvalid
...
INV_ISSUE_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'AllpayAPI', 'InvQueryAllowanceInvalid', 'Initial_Data',
                                  'Inv.csv')
...
INV_ALLOWANCE_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'AllpayAPI', 'InvQueryAllowanceInvalid', 'Initial_Data',
                                      'InvAllowance.csv')
...
INV_ALLOWNACE_INVALID_CSV = os.path.join(ROOTDIR, 'Test_Data', 'AllpayAPI', 'InvQueryAllowanceInvalid', 'Initial_Data',
                                         'Invalid.csv')
...
invalid_info = EXEC_ACT(ALL_INV_API.genOrderRequestInfo, INV_ALLOWNACE_INVALID_CSV, all_rtn_dict, exclusive_list,
                        revert_list)
...
Query_ALLINVALID_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'AllpayAPI', 'InvQueryAllowanceInvalid', CASE_NAME,
                                         'OrderInfo.csv')

inv_query_info = EXEC_ACT(ACT_API.genOrderRequestInfo, Query_ALLINVALID_INFO_CSV, all_rtn_dict)

# print 'genOrderRequestInfo: ', inv_query_info

order_info_res = EXEC_ACT(ACT_API.genPostRequestToAPI, inv_query_info)

VERIFY(VER_API.verifyQueryAllowInvalidResult, order_info_res, CASE_NAME)
