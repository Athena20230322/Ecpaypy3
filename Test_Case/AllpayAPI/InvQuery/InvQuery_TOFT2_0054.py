...
INV_ISSUE_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'AllpayAPI', 'InvQuery', 'Initial_Data', 'InvTaxType9.csv')
...
certain_keys = ['IIS_Tax_Type', 'ItemTaxType']

inv_info = EXEC_ACT(ISSUE_API.quote_item, inv_info, revert_list)

# verification
VERIFY(VER_API.verifyNotEmpty, 'ItemTaxType', query_rtn_dict)
