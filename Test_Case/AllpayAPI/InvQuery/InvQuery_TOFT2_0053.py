...
INV_ISSUE_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'AllpayAPI', 'InvQuery', 'Initial_Data', 'InvMultiItem.csv')
...
certain_keys = ['ItemName', 'ItemCount', 'ItemWord', 'ItemPrice', 'ItemAmount']
