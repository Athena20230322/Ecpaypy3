...
INV_ISSUE_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'AllpayAPI', 'InvQuery', 'Initial_Data', 'InvInvoiceRemark.csv')
...
certain_keys = ['InvoiceRemark']

inv_info = EXEC_ACT(ISSUE_API.quote_item, inv_info, revert_list)

# verification
VERIFY(VER_API.verifyNotEmpty, 'InvoiceRemark', query_rtn_dict)
