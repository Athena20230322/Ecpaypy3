...
INV_ISSUE_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'AllpayAPI', 'InvQuery', 'Initial_Data', 'InvClearance.csv')
...
certain_keys = ['IIS_Clearance_Mark']

inv_info = EXEC_ACT(ISSUE_API.quote_item, inv_info, revert_list)

# verification
VERIFY(VER_API.verifyNotEmpty, 'IIS_Clearance_Mark', query_rtn_dict)
