...
ACT_API = actInvIssue()
VER_API = verifyInvIssue()

#Testing exec

INV_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'AllpayAPI', 'InvIssue', CASE_NAME, 'Inv.csv')
...
# VERIFY
VERIFY(VER_API.verifyResponseValue, res_dict, CASE_NAME, 'fail')
