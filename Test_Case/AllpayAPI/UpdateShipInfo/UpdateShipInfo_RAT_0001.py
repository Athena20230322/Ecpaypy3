...
from Allpay.ProdActions.ActAllpayAPI.ActUpdateShipInfo import actUpdateShipInfo
from Allpay.Verification.VerifyAllpayAPI.VerifyUpdateShipInfo import verifyUpdateShipInfo
...
#EXEC_ACT(ORDER_API.inputPaymentPageCreditInfo, 'F128029956', '4311-9522-2222-2222', '22', '05', '222', '0911429215')

#otp_info= EXEC_ACT(ORDER_API.queryCreditOTP, '0911429215')
...
B2C_ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_data', 'AllpayAPI', 'UpdateShipInfo', 'Initial_Data', 'Create.csv')
...
UPDATE_SHIPMENT_INFO_CSV = os.path.join(ROOTDIR, 'Test_data', 'AllpayAPI', 'UpdateShipInfo', CASE_NAME, 'OrderInfo.csv')

update_shipment_info = EXEC_ACT(ACT_API.genUpdateShipInfo, UPDATE_SHIPMENT_INFO_CSV)
