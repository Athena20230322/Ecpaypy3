...
from Allpay.Verification.VerifyAllpayAPI.VerifyReturnCVS import verifyReturnCVS
...
# EXEC_ACT(ACT_API.inputPaymentPageCreditInfoAP, 'A123456789', '4311-9522-2222-2222', '22', '05', '222', '0922652130')
...
ORDER_INFO_C2C = os.path.join(ROOTDIR, 'Test_Data', 'AllpayAPI', 'ReturnCVS', CASE_NAME, 'OrderInfo.csv')

modify_str = EXEC_ACT(ACT_API.modifyAllpaylogisticsSplit, order_info_crt_res)

order_info_returncvs = EXEC_ACT(ACT_API.genOrderRequestCVS, ORDER_INFO_C2C, modify_str)

EXEC_ACT(ACT_API.createOrderByBrowser, DRIVER, order_info_returncvs, 'ReturnCVS_API')

VERIFY(VER_API.verifyReturnCVSCloseResult)
