...
EXEC_ACT(ACT_API.loginPaymentPage, 'stageuser001', 'test1234')

EXEC_ACT(ACT_API.submitCVSPaymentRequest)
...
VERIFY(VER_API.verifyPaymentInfo, MERC_TID, CASE_NAME, 'CVS')
