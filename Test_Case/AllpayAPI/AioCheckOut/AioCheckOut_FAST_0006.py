...
from Allpay.Verification.VerifyAllpayAPI.VerifyAioCheckOut import verifyAioCheckOut
...
EXEC_ACT(ACT_API.loginPaymentPage, 'qaat0001', 'pw0001')

EXEC_ACT(ACT_API.inputPaymentPageCreditInfo, '4311-9522-2222-2222', '22', '05', '222', '0963957452', 'P122760841')

#otp_info= EXEC_ACT(ACT_API.queryCreditOTP, '0972005542')
