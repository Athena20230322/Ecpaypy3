...
from Allpay.ProdActions.ActAllpayAPI.ActCancelC2COrder import actCancelC2COrder
from Allpay.Verification.VerifyAllpayAPI.VerifyCancelC2COrder import verifyCancelC2COrder
...
ORDER_INFO_CSV = os.path.join(ROOTDIR, 'Test_Data', 'AllpayAPI', 'CancelC2COrder', 'Initial_Data', 'AioCheckOut.csv')
...
ORDER_INFO_CVS_CRT = os.path.join(ROOTDIR, 'Test_Data', 'AllpayAPI', 'CancelC2COrder', 'Initial_Data', 'Create.csv')
...
ORDER_INFO_C2C = os.path.join(ROOTDIR, 'Test_Data', 'AllpayAPI', 'CancelC2COrder', CASE_NAME, 'OrderInfo.csv')

modify_str = EXEC_ACT(ACT_API.modifyAllpaylogisticsSplit, order_info_crt_res)

order_info_cancel_c2c = EXEC_ACT(ACT_API.genOrderRequestC2C, ORDER_INFO_C2C, modify_str)

EXEC_ACT(ACT_API.createOrderByBrowser, DRIVER, order_info_cancel_c2c, 'Cancel_C2C_API')

VERIFY(VER_API.verifyCancelC2COrderCloseResult)
