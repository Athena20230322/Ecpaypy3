...
class actInvIssueInvalid(APIHelper):
    def __init__(self):
        ...
        self.feature_conf = self.t_helper.getFeatureTestSetting('ModuleWideInfo', feature_cat='AllpayAPI', feature_name='InvIssueInvalid')
    ...
    def genOrderRequestInfo(self, param_csv, invoice_no, revert_params):
