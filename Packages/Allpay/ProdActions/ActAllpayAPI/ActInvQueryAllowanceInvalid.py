...
class actInvQueryAllowanceInvalid(APIHelper):
    def __init__(self):
        self.t_helper = classTestHelper()
        self.feature_conf = self.t_helper.getFeatureTestSetting('ModuleWideInfo', feature_cat='AllpayAPI', feature_name='InvQueryAllowanceInvalid')
    ...
    def genOrderRequestInfo(self, param_csv, request_dict):
    ...
    def genPostRequestToAPI(self, req_info):
        form_act = self.feature_conf['InvQueryAllowanceInvalid_API']
