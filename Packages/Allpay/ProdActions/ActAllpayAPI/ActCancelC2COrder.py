...
class actCancelC2COrder(APIHelper):
    def __init__(self):
        ...
        self.feature_conf = self.t_helper.getFeatureTestSetting('ModuleWideInfo', feature_cat='AllpayAPI', feature_name='CancelC2COrder')
    ...
    def genOrderRequestC2C(self, param_csv, list_index):
        ...
        if list_index is None:
            ...
            req['CVSPaymentNo'] = ''
            req['CVSValidationNo'] = ''
            print(ValueError("genOrderRequestC2C: input AllPayLogisticsID, CVSPaymentNo & CVSValidationNo is None"))
        else:
