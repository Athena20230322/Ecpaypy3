...
class actLoginPage(webOperate):
    def __init__(self, drv, log_file):
        ...
        self.feature_conf = self.helper.getFeatureTestSetting('ModuleWideInfo', feature_cat='AllpayProdSemiAuto', feature_name='LoginPage')
        self.login_url = self.feature_conf['Login_addr']
