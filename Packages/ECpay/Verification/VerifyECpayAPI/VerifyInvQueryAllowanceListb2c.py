...
class verifyInvQueryAllowanceListb2c(APIHelper):
    def __init__(self):
        self.conf = getConfig()
        self.category = 'ECpayAPI'
        self.fea_name = 'InvQueryAllowanceListb2c'
    ...
    def verifyInvQueryAllowanceRequestInfo(self, req_info):
        expect_args_dict = self.returnBodyToDicb2cA(req_info)
        print(req_info)
    ...
    def verifyInvQueryAllowanceResultb2c(self, req_info, case_id):
            ...
            req_info_dict = self.returnBodyToDicb2cA(req_info)
