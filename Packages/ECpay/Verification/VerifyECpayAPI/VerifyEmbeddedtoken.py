...
class verifyEmbeddedtoken(APIHelper):
    def __init__(self):
        self.conf = getConfig()
        self.category = 'ECpayAPI'
        self.fea_name = 'EmbeddedToken'
    ...
    def verifyResponseValuesThreeD(self, case_id, res_dict, data, status='success'):
        ...
        res_dict['TradeStatus'] = str(res_dict['TradeStatus'])
        #res_dict['TradeStatus'] = res_dict['TradeStatus'].rstrip(' ')
