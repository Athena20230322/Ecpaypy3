...
class verifyInvQueryAllowanceInvalidb2c(APIHelper):
    def __init__(self):
        self.conf = getConfig()
        self.category = 'ECpayAPI'
        self.fea_name = 'InvQueryAllowanceInvalidb2c'
    ...
    def verifyQueryAllowInvalidResultb2c(self, req_info, case_id):
        all_verify_data = self.t_helper.getTestDataIniSections(self.category,
                                                               self.fea_name,
                                                               case_id,
                                                               'Verification.ini')
    ...
    def verifyQueryAllowInvalidRequestInfob2c(self, req_info):
