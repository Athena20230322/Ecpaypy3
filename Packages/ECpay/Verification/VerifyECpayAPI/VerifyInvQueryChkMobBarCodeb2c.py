...
class verifyInvQueryChkMobBarCodeb2c(APIHelper):
    def __init__(self):
        self.conf = getConfig()
        self.category = 'ECpayAPI'
        self.fea_name = 'InvQueryChkMobBarCodeb2c'
    ...
    def verifyInvQueryChkMobBarCodeRequestInfob2c(self, case_id, data, status='success'):
        all_verify_data = self.t_helper.getTestDataIniSections(self.category, self.fea_name, case_id,
                                                               'Verification.ini')
