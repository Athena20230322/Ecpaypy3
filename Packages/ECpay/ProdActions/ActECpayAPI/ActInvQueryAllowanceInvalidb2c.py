...
class actInvQueryAllowanceInvalidb2c(APIHelper):
    def __init__(self):
        self.t_helper = classTestHelper()
        self.feature_conf = self.t_helper.getFeatureTestSetting('ModuleWideInfo', feature_cat='ECpayAPI', feature_name='InvQueryAllowanceInvalidb2c')
    ...
    def genOrderRequestInfoB2c(self, param_csv, invoice_info,invoice_info1,inject_value=''):
    ...
    def genPostRequestToAPI(self, req_info):
        form_act = self.feature_conf['InvQueryAllowanceInvalidb2c_API']
