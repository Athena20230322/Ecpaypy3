...
class actEmbeddedGetTokenbyBindingCardv4(APIHelper):
    def __init__(self):
        self.t_helper = classTestHelper()
        self.feature_conf = self.t_helper.getFeatureTestSetting('ModuleWideInfo', feature_cat='ECpayAPI', feature_name='EmbeddedGetTokenbyBindingCardv4')
    ...
    def genOrderRequestInfoTokenFlexible(self, param_csv, token, aes):
        print('111111')
        data = {}
        CardInfo={}
        CardInfo['CardNumber']='4938177777777777'
        CardInfo['CardValidYY'] = '22'
        CardInfo['CardValidMM'] = '11'
        CardInfo['CardCVV2'] = '222'
        CardInfo['BindingCard'] = '0'
