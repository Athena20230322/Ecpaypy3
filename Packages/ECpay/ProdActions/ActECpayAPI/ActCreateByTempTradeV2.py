...
class actCreateByTempTradeV2(APIHelper):
    def __init__(self):
        self.t_helper = classTestHelper()
        self.feature_conf = self.t_helper.getFeatureTestSetting('ModuleWideInfo', feature_cat='ECpayAPI', feature_name='CreateByTempTradeV2')
    ...
    def genOrderRequestInfoB2cCreateBy(self, param_csv, createa, inject_value=''):
        ...
        data['TempLogisticsID'] = createa["TempLogisticsID"]
    ...
    def genOrderRequestInfoB2cPritnTrade(self, param_csv, create, inject_value=''):
        data = self.genArgsDictFromCSV(param_csv)
        rqHeader = self.genArgsDictFromCSV(param_csv)
        # Items = self.genArgsDictFromCSV(param_csv)
        req = {}
