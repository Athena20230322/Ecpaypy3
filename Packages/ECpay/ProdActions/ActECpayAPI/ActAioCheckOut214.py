...
class actAioCheckOut214(APIHelper):
    def __init__(self):
    ...
    def inputPaymentPageCreditInfo(self, card_no, exp_year, exp_month, cvv, cell_no,email,mode):
        op = self.webop
    ...
    def submitATMPaymentRequest(self):
       ...
       # op.clickElem('/html/body/div/div[5]/div[1]/div/div[3]/div/div/div[3]/ul[1]/li[9]/input', findby='xpath')
        op.selectDropboxList('index',9, 'selATMBank')
