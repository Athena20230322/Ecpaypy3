...
class actCreateV2(APIHelper):
    def __init__(self):
        self.t_helper = classTestHelper()
        self.feature_conf = self.t_helper.getFeatureTestSetting('ModuleWideInfo', feature_cat='ECpayAPI', feature_name='CreateV2')
    ...
    def createOrderByBrowser(self):
        op = self.webop
        op.goToURL('http://127.0.0.1/pythonautotest/RedirectToLogisticsSelection.php')
        return
    ...
    def submitLogisticsRequestTCAT(self):
        ...
        op.selectDropboxList('index', 1, 'County')
        time.sleep(5)
        op.selectDropboxList('index', 10, 'Area')
    ...
    def submitLogisticsRequestPOSTOFFICE(self):
        op = self.webop
        # op.clickElem('/html/body/div[1]/div[3]/div/div/div[2]/div[2]/div/div[5]/div/div[3]/button', findby='xpath')
        op.selectDropboxList('index', 2, 'LogisticsType')
