...
class actInvOfflineQueryOfflineMerchantPosSetting(APIHelper):
    def __init__(self):
        self.t_helper = classTestHelper()
        self.feature_conf = self.t_helper.getFeatureTestSetting('ModuleWideInfo', feature_cat='ECpayAPI', feature_name='InvOfflineQueryOfflineMerchantPosSetting')
    ...
    def genOrderRequestInfoInvOfflineQueryOfflineMerchantPosSetting(self, param_csv ):
        data = self.genArgsDictFromCSV(param_csv)
        rqHeader = self.genArgsDictFromCSV(param_csv)
