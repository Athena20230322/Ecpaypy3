...
class actInvAllowanceByCollegiate(APIHelper):
    def __init__(self):
        self.t_helper = classTestHelper()
        self.feature_conf = self.t_helper.getFeatureTestSetting('ModuleWideInfo', feature_cat='ECpayAPI', feature_name='InvAllowanceByCollegiate')
    ...
    def genPostRequestToAPI(self, req_info):
        form_act = self.feature_conf['InvAllowanceByCollegiate_API']
