...
class actInvQueryb2b(APIHelper):
    def __init__(self):
        self.t_helper = classTestHelper()
        self.feature_conf = self.t_helper.getFeatureTestSetting('ModuleWideInfo', feature_cat='ECpayAPI', feature_name='InvQueryb2b')
    ...
    def genOrderRequestInfoB2B(self, param_csv,invoice_info):
       ...
       # data.pop('PlatformID')
        ...
        #rqHeader.pop('InvoiceDateBegin')
        #rqHeader.pop('InvoiceDateEnd')
        #rqHeader.pop('InvoiceNumberBegin')
        #rqHeader.pop('InvoiceNumberEnd')
        #rqHeader.pop('Issue_Status')
    ...
    def genPostRequestToAPI(self, req_info):
        form_act = self.feature_conf['InvQueryb2b_API']
