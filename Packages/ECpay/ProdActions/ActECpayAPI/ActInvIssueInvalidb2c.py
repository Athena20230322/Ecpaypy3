...
class actInvIssueInvalidb2c(APIHelper):
    def __init__(self):
        self.t_helper = classTestHelper()
        self.feature_conf = self.t_helper.getFeatureTestSetting('ModuleWideInfo', feature_cat='ECpayAPI', feature_name='InvIssueInvalidb2c')
    ...
    def genPostRequestToAPIb2c(self, req_info):
        form_act = self.feature_conf['InvIssueInvalidb2c_API']
