...
class actEmbeddedgetuiinfo(APIHelper):
    def __init__(self):
        self.t_helper = classTestHelper()
        self.feature_conf = self.t_helper.getFeatureTestSetting('ModuleWideInfo', feature_cat='ECpayAPI', feature_name='EmbeddedGetUIInfo')
    ...
    def genPostRequestToAPIQuery(self, req_info, keyinfo, data2):
        ...
        print('213123124')
        response = self.postRequestToAPIQueryQ(self.genSession(), req_info1, form_act, Language, UUID, AppName, AppInfo, KeyInfo,
                                              Signature, KeyID,
