...
class actReturnHomeV2(APIHelper):
    def __init__(self):
        self.t_helper = classTestHelper()
        self.feature_conf = self.t_helper.getFeatureTestSetting('ModuleWideInfo', feature_cat='ECpayAPI', feature_name='ReturnHomeV2')
    ...
    def genOrderRequestInfoB2c(self, param_csv):
       ...
       # req['PlatformID'] = ''
        ...
        rqHeader.pop('Distance')
        rqHeader.pop('Specification')
        rqHeader.pop('ScheduledPickupTime')
        rqHeader.pop('ScheduledDeliveryTime')
        rqHeader.pop('ScheduledDeliveryDate')
