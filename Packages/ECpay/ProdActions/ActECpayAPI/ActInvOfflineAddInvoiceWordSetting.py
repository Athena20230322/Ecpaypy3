...
class actInvOfflineAddInvoiceWordSetting(APIHelper):
    def __init__(self):
        self.t_helper = classTestHelper()
        self.feature_conf = self.t_helper.getFeatureTestSetting('ModuleWideInfo', feature_cat='ECpayAPI', feature_name='InvOfflineAddInvoiceWordSetting')
    ...
    def genOrderRequestInfoInvInvOfflineAddInvoiceWordSetting(self, param_csv ):
        data = self.genArgsDictFromCSV(param_csv)
        rqHeader = self.genArgsDictFromCSV(param_csv)
        ...
        rqHeader.pop('InvType')
        rqHeader.pop('InvoiceHeader')
        rqHeader.pop('InvoiceStart')
        rqHeader.pop('InvoiceEnd')
