...
class actprintFAMIC2COrder(APIHelper):
    def __init__(self):
        ...
        self.feature_conf = self.t_helper.getFeatureTestSetting('ModuleWideInfo', feature_cat='ECpayAPI', feature_name='printFAMIC2COrder')
    ...
    def genOrderRequestC2C(self, param_csv, list_index, inject_value=''):
        ...
        if list_index is None:
            ...
            req['CVSPaymentNo'] = ''
            raise ValueError("genOrderRequestC2C: input AllPayLogisticsID & CVSPaymentNo is None")
        else:
