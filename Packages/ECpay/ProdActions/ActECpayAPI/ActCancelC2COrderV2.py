...
class actCancelC2COrderV2(APIHelper):
    def __init__(self):
        self.t_helper = classTestHelper()
        self.feature_conf = self.t_helper.getFeatureTestSetting('ModuleWideInfo', feature_cat='ECpayAPI', feature_name='CancelC2COrderV2')
    ...
    def genOrderRequestInfoB2cShipInfoV2(self, param_csv, create, inject_value=''):
    ...
    def decryptDatab2cUpdateShipInfo(self, data):
        # data = self.urlDecode(data)
        print(data)
